...
if (!args[0]) return m.reply("Ingresa el enlace del vídeo")
await m.react('⌛')
try {
...
handler.command = /^(instagramdl|instagram|igdl|ig|instagramdl2|instagram2|igdl2|ig2|instagramdl3|instagram3|igdl3|ig3|facebook|fb|tiktok|tt)$/i
